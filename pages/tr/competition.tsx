         ...
         <Container> 
           <section className="flex-col text-justify flex items-center md:justify-between pt-6 pb-6"> 
             ...
             <h4 className="text-justify text-md md:pl-8"> 
               MFH, 4054 sayılı Rekabetin Korunması Hakkında Kanun kapsamında sektörünüz ve şirketinizin adil rekabet kurallarına uygun ve uyumlu çalışmasını sağlayacak aşağıdaki hizmetleri sunar;<br /> 
               <br /> 
