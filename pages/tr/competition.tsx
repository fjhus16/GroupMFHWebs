        ...
        <Container>
          <section className="flex-col text-justify flex items-center md:justify-between pt-6 pb-6">
            ...
            <h4 className="text-justify text-md md:pl-8">
              MFH Group, 4054 sayılı Rekabetin Korunması Hakkında Kanun
              kapsamında sektörünüz ve şirketinizin adil rekabet kurallarına
              uygun ve uyumlu çalışmasını sağlayacak aşağıdaki hizmetleri sunar;
              <br />
            </h4>
            <br />
            <p className="text-left">
              ✓ Şirketinize özgü rekabet uyum programının hazırlanması
              <br />
              ✓ Rekabet Kurulu tarafından yürütülen soruşturmalara ilişkin
              hukuki danışmanlık hizmetleri (idari yargı aşamaları dahil)
              <br />
              ✓ Birleşme & devralmalar
              <br />
              ✓ Menfi tespit ve muafiyet başvurusu işlemleri
              <br />
            </p>
          </section>
