    ...
    <>
      <Layout>
        ...
        <div className='fixed h-[400px] ism:h-[450px] w-screen -z-30'>
          ...
          <p className='[text-shadow:_0_2px_0_rgb(0_0_0_/_80%)] text-xl ism:text-3xl md:text-4xl text-white fixed font-bold mt-16 ism:mt-24 lg:mt-40 ml-6 ism:ml-8 md:ml-60 -z-20 mx-auto'>Hedef, başarının ilk adımıdır.</p>
