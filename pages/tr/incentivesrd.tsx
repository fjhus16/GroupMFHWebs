...
export default function Incentivesrd({ allPosts }: Props) {
  const filteredPosts = allPosts
    .filter(
      (post) =>
        post.lang === "tr" &&
        post.serv.includes("Teşvik Hizmetleri ve Ar-Ge Danışmalığı")
    )
        ...
        <Container>
          <section className="flex-col flex items-center md:justify-between pt-6 pb-6">
            ...
            <h4 className="text-justify text-md md:pl-8">
              MFH Group, müşterilerinin Vergi, Teşvik, İstisna gibi teknik ve
              karmaşık bir yapıya sahip konuları ve bu konulara ilişkin
              mevzuatlardan kaynaklı uyuşmazlıklarının çözümüne ilişkin ihtiyaç
              duyabileceği aşağıdaki hizmetleri çözüm odaklı bakış açılarıyla
              sunmaktadır:
              <br />
              <br />
              <p className="text-left">
                ✓ Yatırım Teşvik Mevzuatı (Yatırım İndirimi İstisnası, KDV
                İstisnası, Vergi-Resim, Harç İstisnası vb.) ile İlgili
                Danışmanlık
                <br />
                ✓ Doğrudan Yabancı Yatırımlar Kanunu Çerçevesindeki Uygulamalar
                ile İlgili Danışmanlık
                <br />
                ...
                <br />
                ✓ “Görünmeyen İşlemler” Olarak Tanımlanan İşlemlerdeki Vergisel
                Yükümlülüklerin Analizi
                <br />
                ✓ Kaynak Kullanımını Destekleme Fonu ile İlgili Yükümlülükler ve
                Uygulamaları
                <br />✓ Diğer Vergi Teşvikleri
              </p>
            </h4>
          </section>{" "}
