        ...
        <div className='z-20 bg-white relative md:mt-[450px]'>
          ...
          {Array.from(categories).map((category) => (
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <Link href="/en/blog" className="text-sm ism:text-md mx-3 bg-gray-700 hover:bg-white hover:text-black border border-black text-white font-bold py-3 px-10 lg:px-8 duration-200 transition-colors mb-6">
                More posts
              </Link>
            </div>
            <ContactForm />
