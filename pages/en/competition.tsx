         ...
         <Container> 
           <section className="flex-col text-justify flex items-center md:justify-between pt-6 pb-6"> 
             ...
             <h4 className="text-justify text-md md:pl-8"> 
               MFH provides the following services to ensure that your industry and company operate in compliance with fair competition rules within the scope of Law No. 4054 on Protection of Competition:<br /> 
               <br /> 
