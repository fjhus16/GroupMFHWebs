...
const Services = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            text: <>MFH Group, şirketlere, Sosyal Güvenlik Kurumu işlemleri, fesih süreçleri, işe iade ve<br />hesaplamaları, kıdem, ihbar ve izin ücreti, işyerinin devri, birleşmesi, iş sözleşmeleri ve yasal<br />tüm yükümlülüklere uyum çalışmasının yapılması gibi iş ve sosyal güvenlik alanında çözüm oluşturmaktadır.</>
        },
        {
        ...
        },
        {
            ...
            text: <>6102 sayılı Türk Ticaret Kanunu ve bu Kanuna ilişkin çıkarılan tali mevzuata göre ticari<br />işletmelerin ve şirketlerin tür değişikliği; şirketlerin birleşme veya bölünme işlemleri vergi<br />mevzuatıyla uyumlu olarak yapılmasında gerekli hizmetler sunulmaktadır.</>
        },
    ];
