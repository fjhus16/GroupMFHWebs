...
const Header = () => {
  ...
  return (
    ...
    <Link className='font-bold text-3xl ism:text-5xl' href='/tr/'><Image src={'/assets/header/logo.png'} alt={'MFH Group Logo'} width={200} height={120}></Image></Link>
      <div className='grow'>
        <div className='hidden sm:flex font-bold items-center justify-end gap-2 md:gap-8'>
          <Link className='hover:underline text-xl lg:text-2xl' href={ asPath.replace('/tr', '/en') }>English</Link>
        ...
        <Popover.Panel className='absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden'>
          <div className='rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 divide-y-2 divide-gray-500'>
            <div className='flex items-center justify-between'>
              <Link className='font-bold ml-5 mt-3 text-5xl' href='/tr/'>MFH Group</Link>
          ...
          <Link className='focus:outline-none focus:underline px-2 mt-4 text-3xl' href={ asPath.replace('/tr', '/en') }>English</Link>
