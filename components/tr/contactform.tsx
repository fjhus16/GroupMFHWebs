   ...
   return (
    <div className='pb-4 pt-2 border bg-white rounded-md mt-6 mx-auto md:w-[40vw]'>
      <form className='flex pt-5 gap-5 flex-col md:w-[40vw] justify-center items-center' action="https://formsubmit.co/e4d7aa3a78d1dbb9a2517df63907c970" method="POST">
        ...
        <TextField required className='w-[90%]' id="IsimGiris" label="İsminiz" name="isim" variant="outlined" />
        <TextField required className='w-[90%]' id="EmailGiris" label="E-posta adresiniz" name="email" variant="outlined" />
        <TextField className='w-[90%]' id="TelfeonGiris" label="Telefon numaranız" name="telefon" variant="outlined" />
        <TextField className='w-[90%]' id="SirketGiris" label="Şirketinizin adı" name="şirket" variant="outlined" />
        <TextField required className='w-[90%]' multiline id="MesajGiris" label="Mesajınız" name="mesaj" variant="outlined" />
